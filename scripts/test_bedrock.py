...
def main():
    ...
    try:
        ...
        print("  2. IAM permissions — the credentials need bedrock:InvokeModel (or the")
        print("     AmazonBedrockFullAccess managed policy) attached. Model access no")
        print("     longer needs separate manual enabling (AWS retired the Model Access")
        print("     console page on Sep 29, 2025 — access is now automatic per-account,")
        print("     controlled only via IAM/SCP policies).")
